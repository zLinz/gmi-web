(function($) {
    var Global = {
        ...
        login: {
            ...
            //忘记密码页面url
            forgetPwdUrl: 'app/login/forget-pwd.html',
            //注册用户页面url
            register: 'app/login/register.html',
        },
        bulletin: {
            detail: 'app/bulletin/bulletin-detail.html'
        },
        repair: {
            url: 'app/repair/repair.html',
            detail: 'app/repair/repair-detail.html'
        },
        lost: {
            url: 'app/lost/lost.html',
            detail: 'app/lost/lost-detail.html'
        },
        mine: {
            repair: 'app/mine/mine-repair.html',
            lost: 'app/mine/mine-lost.html',
            message: 'app/mine/mine-message.html'
        },
        release: {
            repair: 'app/release/release-repair.html'
        },
        worker: {
            login: 'app/worker/worker-login.html',
            query: 'app/worker/worker-query.html',
            detail: 'app/worker/worker-detail.html'
        }
    };
